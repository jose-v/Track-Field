...
const Step1WorkoutDetails: React.FC<Step1WorkoutDetailsProps> = ({
  ...
  return (
    <Box w="100%" h="calc(100vh - 400px)" bg={bgColor}>
      <VStack spacing={6} align="stretch" w="100%" h="100%">
        ...
        <HStack spacing={4} align="start" w="100%" flex="1">
          {/* Template Type Selection */}
          <Card flex="1" h="100%" variant="outline" shadow="none" bg={cardBg} borderColor={borderColor}>
            <CardBody p={6} h="100%" display="flex" flexDirection="column">
              <VStack spacing={4} align="stretch" h="100%">
                ...
                {/* Date Selection for Single Day Workout */}
                {templateType === 'single' && (
                  <VStack spacing={4} w="100%" pt={4} borderTop="1px solid" borderColor={borderColor}>
                    <VStack spacing={3} w="100%">
                      ...
                      <FormControl>
                        <FormLabel fontSize="xs" color={subtitleColor}>Select Date</FormLabel>
                        <Input
                          type="date"
                          value={startDate}
                  ...
                  <VStack spacing={4} w="100%" pt={4} borderTop="1px solid" borderColor={borderColor}>
                    <VStack spacing={3} w="100%">
                      ...
                      <HStack spacing={3} w="100%">
                        <FormControl>
                          <FormLabel fontSize="xs" color={subtitleColor}>From Date</FormLabel>
                          <Input
                            type="date"
                            value={startDate}
                            onChange={(e) => setStartDate(e.target.value)}
                        ...
                        <FormControl>
                          <FormLabel fontSize="xs" color={subtitleColor}>To Date</FormLabel>
                          <Input
                            type="date"
                            value={endDate}
