    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={handleClose} isCentered size="md">
        ...
        <ModalContent bg={bgColor}>
          <ModalHeader color={headerColor}>Share This App</ModalHeader>
          <ModalCloseButton />
          <ModalBody color={bodyTextColor}>
            <VStack spacing={3} align="stretch">
              <Text color={bodyTextColor}>Share this Track & Field app with friends and teammates!</Text>
              ...
              <Text fontWeight="medium" color={bodyTextColor}>Or copy the link</Text>
              <Flex>
                <Input 
                  value={appUrl}
                  isReadOnly
