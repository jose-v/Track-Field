-- Fixed test script for creating soft-deleted items for testing the deleted tab
...
-- Check the actual structure of training_plans table
...
-- Create test deleted items with proper column handling
...
-- Create a test training plan with all required fields
WITH new_plan AS (
