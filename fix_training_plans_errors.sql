...
-- Step 2: Create training_plan_assignments table if it doesn't exist
...
-- Step 6: Create comprehensive RLS policies for training_plans
...
-- Step 7: Create comprehensive RLS policies for training_plan_assignments
...
-- Step 8: Create updated_at trigger for training_plans
